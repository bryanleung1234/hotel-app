...
def api_seed():
    ...
    seed_data = [
        ...
        {'date':'2026-04-29','shift':'早班','meituan_rooms':6,'meituan_income':482.77,'ctrip_rooms':2,'ctrip_income':83.11,'fliggy_rooms':3,'fliggy_income':165.88,'douyin_rooms':1,'douyin_income':82.71,'wechat_rooms':11,'wechat_income':1160,'cash_rooms':2,'cash_income':180,'alipay_rooms':0,'alipay_income':0,'parking_tickets':3,'parking_income':44,'tax':0,'total_rooms':25,'avg_price':87.93,'occupancy_rate':55.0,'revpgr':48.85,'total_income':2198.47},
        {'date':'2026-04-30','shift':'早班','meituan_rooms':17,'meituan_income':2516.37,'ctrip_rooms':4,'ctrip_income':842.35,'fliggy_rooms':1,'fliggy_income':0,'douyin_rooms':0,'douyin_income':0,'wechat_rooms':9,'wechat_income':1300,'cash_rooms':0,'cash_income':0,'alipay_rooms':1,'alipay_income':110,'parking_tickets':3,'parking_income':51,'tax':0,'total_rooms':32,'avg_price':150.61,'occupancy_rate':71.0,'revpgr':107.1,'total_income':4819.72},
        {'date':'2026-05-01','shift':'早班','meituan_rooms':21,'meituan_income':2914.08,'ctrip_rooms':9,'ctrip_income':2583.76,'fliggy_rooms':2,'fliggy_income':134.72,'douyin_rooms':0,'douyin_income':0,'wechat_rooms':12,'wechat_income':1530,'cash_rooms':1,'cash_income':100,'alipay_rooms':0,'alipay_income':0,'parking_tickets':2,'parking_income':32,'tax':18.1,'total_rooms':45,'avg_price':163.2,'occupancy_rate':100.0,'revpgr':163.2,'total_income':7347.66},
        {'date':'2026-05-02','shift':'早班','meituan_rooms':23,'meituan_income':1985.48,'ctrip_rooms':11,'ctrip_income':901.52,'fliggy_rooms':1,'fliggy_income':198.4,'douyin_rooms':1,'douyin_income':272.69,'wechat_rooms':11,'wechat_income':1580,'cash_rooms':1,'cash_income':110,'alipay_rooms':0,'alipay_income':0,'parking_tickets':2,'parking_income':24,'tax':0,'total_rooms':48,'avg_price':105.8,'occupancy_rate':100.0,'revpgr':112.9,'total_income':5082.09},
        {'date':'2026-05-03','shift':'早班','meituan_rooms':9,'meituan_income':522.18,'ctrip_rooms':12,'ctrip_income':698.2,'fliggy_rooms':3,'fliggy_income':314.7,'douyin_rooms':1,'douyin_income':0,'wechat_rooms':12,'wechat_income':1740,'cash_rooms':2,'cash_income':260,'alipay_rooms':1,'alipay_income':200,'parking_tickets':3,'parking_income':112,'tax':0,'total_rooms':40,'avg_price':96.1,'occupancy_rate':88.0,'revpgr':85.4,'total_income':3847.08},
