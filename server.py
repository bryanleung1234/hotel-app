...
def api_seed():
    ...
    db = get_db()
    seed_data = [
    {'date': '2026-04-01', 'shift': '早班',
     'meituan_rooms': 7, 'meituan_income': 691.07,
     'ctrip_rooms': 6, 'ctrip_income': 517.57,
     'fliggy_rooms': 0, 'fliggy_income': 0.0,
     'douyin_rooms': 0, 'douyin_income': 0.0,
     'wechat_rooms': 11, 'wechat_income': 1120.0,
     'cash_rooms': 2, 'cash_income': 90.0,
     'alipay_rooms': 3, 'alipay_income': 280.0,
     'parking_tickets': 1, 'parking_income': 10.0,
     'tax': 0.0, 'total_rooms': 26, 'avg_price': 104.7,
     'occupancy_rate': 57.7, 'revpgr': 60.5, 'total_income': 2723.64,
     'room_types': None, 'note': '', 'uploaded_by': 'seed'},
    {'date': '2026-04-02', 'shift': '早班',
     'meituan_rooms': 7, 'meituan_income': 423.97,
     'ctrip_rooms': 6, 'ctrip_income': 572.01,
     'fliggy_rooms': 3, 'fliggy_income': 205.6,
     'douyin_rooms': 0, 'douyin_income': 0.0,
     'wechat_rooms': 7, 'wechat_income': 580.0,
     'cash_rooms': 2, 'cash_income': 270.0,
     'alipay_rooms': 0, 'alipay_income': 0.0,
     'parking_tickets': 3, 'parking_income': 30.0,
     'tax': 0.0, 'total_rooms': 25, 'avg_price': 83.4,
     'occupancy_rate': 55.5, 'revpgr': 46.3, 'total_income': 2085.58,
     'room_types': None, 'note': '', 'uploaded_by': 'seed'},
    {'date': '2026-04-03', 'shift': '早班',
     'meituan_rooms': 5, 'meituan_income': 476.09,
     'ctrip_rooms': 2, 'ctrip_income': 58.14,
     'fliggy_rooms': 0, 'fliggy_income': 0.0,
     'douyin_rooms': 0, 'douyin_income': 0.0,
     'wechat_rooms': 12, 'wechat_income': 960.0,
     'cash_rooms': 3, 'cash_income': 320.0,
     'alipay_rooms': 0, 'alipay_income': 0.0,
     'parking_tickets': 2, 'parking_income': 20.0,
     'tax': 0.0, 'total_rooms': 22, 'avg_price': 84.28,
     'occupancy_rate': 48.0, 'revpgr': 41.2, 'total_income': 1854.23,
     'room_types': None, 'note': '', 'uploaded_by': 'seed'},
    {'date': '2026-04-04', 'shift': '早班',
     'meituan_rooms': 11, 'meituan_income': 1187.8,
     'ctrip_rooms': 3, 'ctrip_income': 312.51,
     'fliggy_rooms': 0, 'fliggy_income': 0.0,
     'douyin_rooms': 0, 'douyin_income': 0.0,
     'wechat_rooms': 16, 'wechat_income': 2900.0,
     'cash_rooms': 4, 'cash_income': 460.0,
     'alipay_rooms': 2, 'alipay_income': 190.0,
     'parking_tickets': 1, 'parking_income': 10.0,
     'tax': 0.0, 'total_rooms': 36, 'avg_price': 140.7,
     'occupancy_rate': 80.0, 'revpgr': 112.5, 'total_income': 5065.31,
     'room_types': None, 'note': '', 'uploaded_by': 'seed'},
    {'date': '2026-04-05', 'shift': '早班',
     'meituan_rooms': 6, 'meituan_income': 602.09,
     'ctrip_rooms': 1, 'ctrip_income': 82.21,
     'fliggy_rooms': 1, 'fliggy_income': 95.31,
     'douyin_rooms': 0, 'douyin_income': 0.0,
     'wechat_rooms': 11, 'wechat_income': 1030.0,
     'cash_rooms': 4, 'cash_income': 390.0,
     'alipay_rooms': 3, 'alipay_income': 390.0,
     'parking_tickets': 2, 'parking_income': 20.0,
     'tax': 0.0, 'total_rooms': 26, 'avg_price': 97.6,
     'occupancy_rate': 57.7, 'revpgr': 56.4, 'total_income': 2539.61,
     'room_types': None, 'note': '', 'uploaded_by': 'seed'},
    {'date': '2026-04-06', 'shift': '早班',
     'meituan_rooms': 2, 'meituan_income': 219.82,
     'ctrip_rooms': 4, 'ctrip_income': 423.97,
     'fliggy_rooms': 0, 'fliggy_income': 0.0,
     'douyin_rooms': 0, 'douyin_income': 0.0,
     'wechat_rooms': 7, 'wechat_income': 490.0,
     'cash_rooms': 4, 'cash_income': 380.0,
     'alipay_rooms': 1, 'alipay_income': 90.0,
     'parking_tickets': 3, 'parking_income': 30.0,
     'tax': 0.0, 'total_rooms': 18, 'avg_price': 92.1,
     'occupancy_rate': 40.0, 'revpgr': 36.8, 'total_income': 1657.79,
     'room_types': None, 'note': '', 'uploaded_by': 'seed'},
    {'date': '2026-04-07', 'shift': '早班',
     'meituan_rooms': 8, 'meituan_income': 612.53,
     'ctrip_rooms': 6, 'ctrip_income': 374.16,
     'fliggy_rooms': 1, 'fliggy_income': 95.69,
     'douyin_rooms': 0, 'douyin_income': 0.0,
     'wechat_rooms': 6, 'wechat_income': 400.0,
     'cash_rooms': 2, 'cash_income': 190.0,
     'alipay_rooms': 1, 'alipay_income': 90.0,
     'parking_tickets': 3, 'parking_income': 30.0,
     'tax': 0.0, 'total_rooms': 24, 'avg_price': 74.6,
     'occupancy_rate': 53.0, 'revpgr': 39.8, 'total_income': 1792.38,
     'room_types': None, 'note': '', 'uploaded_by': 'seed'},
    {'date': '2026-04-08', 'shift': '早班',
     'meituan_rooms': 5, 'meituan_income': 378.51,
     'ctrip_rooms': 5, 'ctrip_income': 973.56,
     'fliggy_rooms': 1, 'fliggy_income': 71.28,
     'douyin_rooms': 0, 'douyin_income': 0.0,
     'wechat_rooms': 8, 'wechat_income': 650.0,
     'cash_rooms': 3, 'cash_income': 300.0,
     'alipay_rooms': 0, 'alipay_income': 0.0,
     'parking_tickets': 1, 'parking_income': 10.0,
     'tax': 0.0, 'total_rooms': 22, 'avg_price': 108.7,
     'occupancy_rate': 49.0, 'revpgr': 53.1, 'total_income': 2390.35,
     'room_types': None, 'note': '', 'uploaded_by': 'seed'},
    {'date': '2026-04-09', 'shift': '早班',
     'meituan_rooms': 7, 'meituan_income': 559.02,
     'ctrip_rooms': 6, 'ctrip_income': 446.93,
     'fliggy_rooms': 0, 'fliggy_income': 0.0,
     'douyin_rooms': 0, 'douyin_income': 0.0,
     'wechat_rooms': 9, 'wechat_income': 675.0,
     'cash_rooms': 3, 'cash_income': 355.0,
     'alipay_rooms': 0, 'alipay_income': 0.0,
     'parking_tickets': 5, 'parking_income': 50.0,
     'tax': 0.0, 'total_rooms': 25, 'avg_price': 83.4,
     'occupancy_rate': 55.0, 'revpgr': 46.35, 'total_income': 2085.95,
     'room_types': None, 'note': '', 'uploaded_by': 'seed'},
    {'date': '2026-04-10', 'shift': '早班',
     'meituan_rooms': 2, 'meituan_income': 151.7,
     'ctrip_rooms': 5, 'ctrip_income': 500.89,
     'fliggy_rooms': 0, 'fliggy_income': 0.0,
     'douyin_rooms': 0, 'douyin_income': 0.0,
     'wechat_rooms': 10, 'wechat_income': 780.0,
     'cash_rooms': 4, 'cash_income': 320.0,
     'alipay_rooms': 0, 'alipay_income': 0.0,
     'parking_tickets': 3, 'parking_income': 30.0,
     'tax': 0.0, 'total_rooms': 21, 'avg_price': 86.1,
     'occupancy_rate': 47.0, 'revpgr': 40.2, 'total_income': 1807.59,
     'room_types': None, 'note': '', 'uploaded_by': 'seed'},
    {'date': '2026-04-11', 'shift': '早班',
     'meituan_rooms': 6, 'meituan_income': 541.06,
     'ctrip_rooms': 8, 'ctrip_income': 570.0,
     'fliggy_rooms': 2, 'fliggy_income': 198.43,
     'douyin_rooms': 0, 'douyin_income': 0.0,
     'wechat_rooms': 16, 'wechat_income': 1690.0,
     'cash_rooms': 7, 'cash_income': 660.0,
     'alipay_rooms': 1, 'alipay_income': 108.0,
     'parking_tickets': 2, 'parking_income': 20.0,
     'tax': 0.0, 'total_rooms': 40, 'avg_price': 95.7,
     'occupancy_rate': 89.0, 'revpgr': 85.0, 'total_income': 3826.49,
     'room_types': None, 'note': '', 'uploaded_by': 'seed'},
    {'date': '2026-04-12', 'shift': '早班',
     'meituan_rooms': 7, 'meituan_income': 495.52,
     'ctrip_rooms': 4, 'ctrip_income': 242.13,
     'fliggy_rooms': 0, 'fliggy_income': 0.0,
     'douyin_rooms': 0, 'douyin_income': 0.0,
     'wechat_rooms': 14, 'wechat_income': 1290.0,
     'cash_rooms': 2, 'cash_income': 200.0,
     'alipay_rooms': 0, 'alipay_income': 0.0,
     'parking_tickets': 3, 'parking_income': 30.0,
     'tax': 0.0, 'total_rooms': 27, 'avg_price': 83.6,
     'occupancy_rate': 60.0, 'revpgr': 50.2, 'total_income': 2257.65,
     'room_types': None, 'note': '', 'uploaded_by': 'seed'},
    {'date': '2026-04-13', 'shift': '早班',
     'meituan_rooms': 4, 'meituan_income': 299.36,
     'ctrip_rooms': 6, 'ctrip_income': 375.95,
     'fliggy_rooms': 2, 'fliggy_income': 185.58,
     'douyin_rooms': 0, 'douyin_income': 0.0,
     'wechat_rooms': 14, 'wechat_income': 1410.0,
     'cash_rooms': 3, 'cash_income': 360.0,
     'alipay_rooms': 0, 'alipay_income': 0.0,
     'parking_tickets': 2, 'parking_income': 20.0,
     'tax': 4.0, 'total_rooms': 29, 'avg_price': 91.5,
     'occupancy_rate': 64.0, 'revpgr': 59.0, 'total_income': 2654.89,
     'room_types': None, 'note': '', 'uploaded_by': 'seed'},
    {'date': '2026-04-14', 'shift': '早班',
     'meituan_rooms': 7, 'meituan_income': 598.09,
     'ctrip_rooms': 7, 'ctrip_income': 431.34,
     'fliggy_rooms': 1, 'fliggy_income': 81.18,
     'douyin_rooms': 0, 'douyin_income': 0.0,
     'wechat_rooms': 9, 'wechat_income': 930.0,
     'cash_rooms': 5, 'cash_income': 380.0,
     'alipay_rooms': 0, 'alipay_income': 0.0,
     'parking_tickets': 0, 'parking_income': 0.0,
     'tax': 7.0, 'total_rooms': 29, 'avg_price': 83.7,
     'occupancy_rate': 64.0, 'revpgr': 53.9, 'total_income': 2427.61,
     'room_types': None, 'note': '', 'uploaded_by': 'seed'},
    {'date': '2026-04-15', 'shift': '早班',
     'meituan_rooms': 9, 'meituan_income': 647.23,
     'ctrip_rooms': 2, 'ctrip_income': 1039.22,
     'fliggy_rooms': 2, 'fliggy_income': 150.48,
     'douyin_rooms': 0, 'douyin_income': 0.0,
     'wechat_rooms': 14, 'wechat_income': 2120.0,
     'cash_rooms': 5, 'cash_income': 510.0,
     'alipay_rooms': 0, 'alipay_income': 0.0,
     'parking_tickets': 0, 'parking_income': 0.0,
     'tax': 0.0, 'total_rooms': 32, 'avg_price': 140.8,
     'occupancy_rate': 71.0, 'revpgr': 100.1, 'total_income': 4506.93,
     'room_types': None, 'note': '', 'uploaded_by': 'seed'},
    {'date': '2026-04-16', 'shift': '早班',
     'meituan_rooms': 5, 'meituan_income': 422.03,
     'ctrip_rooms': 5, 'ctrip_income': 350.68,
     'fliggy_rooms': 2, 'fliggy_income': 144.87,
     'douyin_rooms': 1, 'douyin_income': 119.54,
     'wechat_rooms': 16, 'wechat_income': 1090.0,
     'cash_rooms': 0, 'cash_income': 0.0,
     'alipay_rooms': 0, 'alipay_income': 0.0,
     'parking_tickets': 0, 'parking_income': 0.0,
     'tax': 0.0, 'total_rooms': 29, 'avg_price': 74.8,
     'occupancy_rate': 64.0, 'revpgr': 48.2, 'total_income': 2170.12,
     'room_types': None, 'note': '', 'uploaded_by': 'seed'},
    {'date': '2026-04-17', 'shift': '早班',
     'meituan_rooms': 21, 'meituan_income': 2091.71,
     'ctrip_rooms': 4, 'ctrip_income': 275.08,
     'fliggy_rooms': 1, 'fliggy_income': 94.17,
     'douyin_rooms': 0, 'douyin_income': 0.0,
     'wechat_rooms': 19, 'wechat_income': 2070.0,
     'cash_rooms': 0, 'cash_income': 0.0,
     'alipay_rooms': 0, 'alipay_income': 0.0,
     'parking_tickets': 0, 'parking_income': 0.0,
     'tax': 0.0, 'total_rooms': 45, 'avg_price': 101.8,
     'occupancy_rate': 100.0, 'revpgr': 101.8, 'total_income': 4580.96,
     'room_types': None, 'note': '', 'uploaded_by': 'seed'},
    {'date': '2026-04-18', 'shift': '早班',
     'meituan_rooms': 13, 'meituan_income': 1134.53,
     'ctrip_rooms': 1, 'ctrip_income': 0.0,
     'fliggy_rooms': 4, 'fliggy_income': 445.9,
     'douyin_rooms': 0, 'douyin_income': 0.0,
     'wechat_rooms': 29, 'wechat_income': 3150.0,
     'cash_rooms': 1, 'cash_income': 90.0,
     'alipay_rooms': 0, 'alipay_income': 0.0,
     'parking_tickets': 2, 'parking_income': 20.0,
     'tax': 0.0, 'total_rooms': 48, 'avg_price': 100.9,
     'occupancy_rate': 107.0, 'revpgr': 107.7, 'total_income': 4845.43,
     'room_types': None, 'note': '', 'uploaded_by': 'seed'},
    {'date': '2026-04-19', 'shift': '早班',
     'meituan_rooms': 11, 'meituan_income': 864.73,
     'ctrip_rooms': 3, 'ctrip_income': 185.35,
     'fliggy_rooms': 4, 'fliggy_income': 479.73,
     'douyin_rooms': 1, 'douyin_income': 104.42,
     'wechat_rooms': 20, 'wechat_income': 1710.0,
     'cash_rooms': 0, 'cash_income': 0.0,
     'alipay_rooms': 2, 'alipay_income': 170.0,
     'parking_tickets': 4, 'parking_income': 40.0,
     'tax': 111.8, 'total_rooms': 41, 'avg_price': 89.4,
     'occupancy_rate': 91.0, 'revpgr': 81.5, 'total_income': 3666.03,
     'room_types': None, 'note': '', 'uploaded_by': 'seed'},
    {'date': '2026-04-20', 'shift': '早班',
     'meituan_rooms': 7, 'meituan_income': 589.13,
     'ctrip_rooms': 1, 'ctrip_income': 0.0,
     'fliggy_rooms': 0, 'fliggy_income': 0.0,
     'douyin_rooms': 0, 'douyin_income': 0.0,
     'wechat_rooms': 21, 'wechat_income': 2880.0,
     'cash_rooms': 0, 'cash_income': 0.0,
     'alipay_rooms': 1, 'alipay_income': 90.0,
     'parking_tickets': 4, 'parking_income': 40.0,
     'tax': 0.0, 'total_rooms': 30, 'avg_price': 120.63,
     'occupancy_rate': 66.0, 'revpgr': 80.4, 'total_income': 3619.13,
     'room_types': None, 'note': '', 'uploaded_by': 'seed'},
    {'date': '2026-04-21', 'shift': '早班',
     'meituan_rooms': 5, 'meituan_income': 356.07,
     'ctrip_rooms': 2, 'ctrip_income': 76.81,
     'fliggy_rooms': 4, 'fliggy_income': 306.66,
     'douyin_rooms': 0, 'douyin_income': 0.0,
     'wechat_rooms': 12, 'wechat_income': 1000.0,
     'cash_rooms': 0, 'cash_income': 0.0,
     'alipay_rooms': 1, 'alipay_income': 90.0,
     'parking_tickets': 2, 'parking_income': 20.0,
     'tax': 0.0, 'total_rooms': 24, 'avg_price': 77.89,
     'occupancy_rate': 53.0, 'revpgr': 41.54, 'total_income': 1869.54,
     'room_types': None, 'note': '', 'uploaded_by': 'seed'},
    {'date': '2026-04-22', 'shift': '早班',
     'meituan_rooms': 8, 'meituan_income': 629.17,
     'ctrip_rooms': 3, 'ctrip_income': 155.29,
     'fliggy_rooms': 0, 'fliggy_income': 0.0,
     'douyin_rooms': 1, 'douyin_income': 208.29,
     'wechat_rooms': 17, 'wechat_income': 1700.0,
     'cash_rooms': 2, 'cash_income': 200.0,
     'alipay_rooms': 1, 'alipay_income': 90.0,
     'parking_tickets': 2, 'parking_income': 20.0,
     'tax': 6.8, 'total_rooms': 32, 'avg_price': 94.36,
     'occupancy_rate': 71.0, 'revpgr': 67.1, 'total_income': 3019.55,
     'room_types': None, 'note': '', 'uploaded_by': 'seed'},
    {'date': '2026-04-23', 'shift': '早班',
     'meituan_rooms': 9, 'meituan_income': 717.23,
     'ctrip_rooms': 2, 'ctrip_income': 84.78,
     'fliggy_rooms': 0, 'fliggy_income': 0.0,
     'douyin_rooms': 1, 'douyin_income': 0.0,
     'wechat_rooms': 18, 'wechat_income': 1690.0,
     'cash_rooms': 0, 'cash_income': 0.0,
     'alipay_rooms': 1, 'alipay_income': 90.0,
     'parking_tickets': 2, 'parking_income': 20.0,
     'tax': 15.3, 'total_rooms': 31, 'avg_price': 85.33,
     'occupancy_rate': 68.0, 'revpgr': 58.78, 'total_income': 2645.31,
     'room_types': None, 'note': '', 'uploaded_by': 'seed'},
    {'date': '2026-04-24', 'shift': '早班',
     'meituan_rooms': 11, 'meituan_income': 1048.17,
     'ctrip_rooms': 5, 'ctrip_income': 750.93,
     'fliggy_rooms': 1, 'fliggy_income': 94.92,
     'douyin_rooms': 1, 'douyin_income': 81.37,
     'wechat_rooms': 14, 'wechat_income': 1480.0,
     'cash_rooms': 2, 'cash_income': 170.0,
     'alipay_rooms': 2, 'alipay_income': 640.0,
     'parking_tickets': 9, 'parking_income': 90.0,
     'tax': 18.1, 'total_rooms': 36, 'avg_price': 142.2,
     'occupancy_rate': 80.0, 'revpgr': 97.96, 'total_income': 4408.49,
     'room_types': None, 'note': '', 'uploaded_by': 'seed'},
    {'date': '2026-04-25', 'shift': '早班',
     'meituan_rooms': 15, 'meituan_income': 1285.35,
     'ctrip_rooms': 8, 'ctrip_income': 1281.05,
     'fliggy_rooms': 2, 'fliggy_income': 251.1,
     'douyin_rooms': 1, 'douyin_income': 102.12,
     'wechat_rooms': 17, 'wechat_income': 1938.0,
     'cash_rooms': 2, 'cash_income': 200.0,
     'alipay_rooms': 2, 'alipay_income': 300.0,
     'parking_tickets': 1, 'parking_income': 10.0,
     'tax': 0.0, 'total_rooms': 47, 'avg_price': 117.6,
     'occupancy_rate': 104.0, 'revpgr': 122.83, 'total_income': 5527.62,
     'room_types': None, 'note': '', 'uploaded_by': 'seed'},
    {'date': '2026-04-26', 'shift': '早班',
     'meituan_rooms': 8, 'meituan_income': 638.08,
     'ctrip_rooms': 3, 'ctrip_income': 81.62,
     'fliggy_rooms': 0, 'fliggy_income': 0.0,
     'douyin_rooms': 0, 'douyin_income': 0.0,
     'wechat_rooms': 24, 'wechat_income': 2430.0,
     'cash_rooms': 1, 'cash_income': 200.0,
     'alipay_rooms': 3, 'alipay_income': 100.0,
     'parking_tickets': 3, 'parking_income': 30.0,
     'tax': 0.0, 'total_rooms': 39, 'avg_price': 91.63,
     'occupancy_rate': 86.0, 'revpgr': 79.41, 'total_income': 3573.7,
     'room_types': None, 'note': '', 'uploaded_by': 'seed'},
    {'date': '2026-04-27', 'shift': '早班',
     'meituan_rooms': 15, 'meituan_income': 1243.32,
     'ctrip_rooms': 2, 'ctrip_income': 0.0,
     'fliggy_rooms': 3, 'fliggy_income': 209.22,
     'douyin_rooms': 0, 'douyin_income': 0.0,
     'wechat_rooms': 17, 'wechat_income': 1520.0,
     'cash_rooms': 1, 'cash_income': 110.0,
     'alipay_rooms': 3, 'alipay_income': 100.0,
     'parking_tickets': 2, 'parking_income': 20.0,
     'tax': 15.6, 'total_rooms': 41, 'avg_price': 76.66,
     'occupancy_rate': 91.0, 'revpgr': 69.85, 'total_income': 3143.4,
     'room_types': None, 'note': '', 'uploaded_by': 'seed'},
    {'date': '2026-04-28', 'shift': '早班',
     'meituan_rooms': 8, 'meituan_income': 632.01,
     'ctrip_rooms': 3, 'ctrip_income': 88.51,
     'fliggy_rooms': 3, 'fliggy_income': 565.8,
     'douyin_rooms': 0, 'douyin_income': 0.0,
     'wechat_rooms': 14, 'wechat_income': 1480.0,
     'cash_rooms': 0, 'cash_income': 0.0,
     'alipay_rooms': 2, 'alipay_income': 100.0,
     'parking_tickets': 1, 'parking_income': 10.0,
     'tax': 62.7, 'total_rooms': 30, 'avg_price': 101.66,
     'occupancy_rate': 66.0, 'revpgr': 67.77, 'total_income': 3050.02,
     'room_types': None, 'note': '', 'uploaded_by': 'seed'},
    {'date': '2026-04-29', 'shift': '早班',
     'meituan_rooms': 6, 'meituan_income': 482.77,
     'ctrip_rooms': 2, 'ctrip_income': 83.11,
     'fliggy_rooms': 3, 'fliggy_income': 165.88,
     'douyin_rooms': 1, 'douyin_income': 82.71,
     'wechat_rooms': 11, 'wechat_income': 1160.0,
     'cash_rooms': 2, 'cash_income': 180.0,
     'alipay_rooms': 0, 'alipay_income': 0.0,
     'parking_tickets': 2, 'parking_income': 20.0,
     'tax': 0.0, 'total_rooms': 25, 'avg_price': 0,
     'occupancy_rate': 0, 'revpgr': 0, 'total_income': 2198.47,
     'room_types': None, 'note': '', 'uploaded_by': 'seed'},
    {'date': '2026-04-30', 'shift': '早班',
     'meituan_rooms': 17, 'meituan_income': 2516.37,
     'ctrip_rooms': 4, 'ctrip_income': 842.35,
     'fliggy_rooms': 1, 'fliggy_income': 0.0,
     'douyin_rooms': 0, 'douyin_income': 0.0,
     'wechat_rooms': 9, 'wechat_income': 1300.0,
     'cash_rooms': 0, 'cash_income': 0.0,
     'alipay_rooms': 1, 'alipay_income': 110.0,
     'parking_tickets': 1, 'parking_income': 10.0,
     'tax': 0.0, 'total_rooms': 32, 'avg_price': 0,
     'occupancy_rate': 0, 'revpgr': 0, 'total_income': 4819.72,
     'room_types': None, 'note': '', 'uploaded_by': 'seed'},
    {'date': '2026-05-01', 'shift': '早班',
     'meituan_rooms': 21, 'meituan_income': 2914.08,
     'ctrip_rooms': 9, 'ctrip_income': 2583.76,
     'fliggy_rooms': 2, 'fliggy_income': 134.72,
     'douyin_rooms': 0, 'douyin_income': 0.0,
     'wechat_rooms': 12, 'wechat_income': 1530.0,
     'cash_rooms': 1, 'cash_income': 100.0,
     'alipay_rooms': 0, 'alipay_income': 0.0,
     'parking_tickets': 3, 'parking_income': 30.0,
     'tax': 0.0, 'total_rooms': 45, 'avg_price': 0,
     'occupancy_rate': 0, 'revpgr': 0, 'total_income': 7347.66,
     'room_types': None, 'note': '', 'uploaded_by': 'seed'},
    {'date': '2026-05-02', 'shift': '早班',
     ...
     'wechat_rooms': 11, 'wechat_income': 1580.0,
     'cash_rooms': 1, 'cash_income': 110.0,
     'alipay_rooms': 0, 'alipay_income': 0.0,
     'parking_tickets': 2, 'parking_income': 20.0,
     'tax': 0.0, 'total_rooms': 48, 'avg_price': 0,
     'occupancy_rate': 0, 'revpgr': 0, 'total_income': 5082.09,
     'room_types': None, 'note': '', 'uploaded_by': 'seed'},
    {'date': '2026-05-03', 'shift': '早班',
     'meituan_rooms': 9, 'meituan_income': 522.18,
     'ctrip_rooms': 12, 'ctrip_income': 698.2,
     'fliggy_rooms': 3, 'fliggy_income': 314.7,
     'douyin_rooms': 1, 'douyin_income': 0.0,
     'wechat_rooms': 12, 'wechat_income': 1740.0,
     'cash_rooms': 2, 'cash_income': 260.0,
     'alipay_rooms': 1, 'alipay_income': 200.0,
     'parking_tickets': 6, 'parking_income': 60.0,
     'tax': 0.0, 'total_rooms': 40, 'avg_price': 0,
     'occupancy_rate': 0, 'revpgr': 0, 'total_income': 3847.08,
     'room_types': None, 'note': '', 'uploaded_by': 'seed'}
]
...
def api_clear():
    ...
    if USE_POSTGRES:
        ...
        db.execute('DELETE FROM daily_reports')
        db.execute('DELETE FROM monthly_cache')
        db.commit()
